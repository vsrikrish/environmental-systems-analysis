...
| Lab 2 | {{< fa sharp laptop-code >}}{style="color:grey"} | {{< fa sharp key-skeleton >}}{style="color:grey"} | Oct 02, 2024 |
| Lab 3 | {{< fa sharp laptop-code >}}{style="color:grey"} | {{< fa sharp key-skeleton >}}{style="color:grey"} | Oct 23, 2023 |
| Lab 4 | {{< fa sharp laptop-code >}}{style="color:grey"} | {{< fa sharp key-skeleton >}}{style="color:grey"} | Nov 13, 2023 |
| Lab 5 | {{< fa sharp laptop-code >}}{style="color:grey"} | {{< fa sharp key-skeleton >}}{style="color:grey"} | Nov 25, 2023 |
