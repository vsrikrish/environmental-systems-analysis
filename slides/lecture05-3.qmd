...
- We discussed several approaches to optimization, all of which have some restrictions.
- Constraints add complexity, since we need to consider the constraint for optima.

# Upcoming Schedule

## Next Classes

**Monday**: Solving linear models (linear programming)
