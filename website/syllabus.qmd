...
- {{< fa sharp building-user title="Office Hours" >}} TBD
:::
...
- {{< fa sharp calendar title="Class Days" >}} MW
- {{< fa sharp clock title="Class Time" >}} 11:25-12:40
- {{< fa sharp university title="Class Location" >}} 105 Riley-Robb
...
- You will be required to submit a PDF of your completed notebook to Gradescope by 9:00pm one week after the lab session. Tag the answers to each question: points will be deducted if this is not done.
...
Some notes on assignment and grading logistics:
  ...
  * Rubrics will be provided for the homeworks as part of the assignments.s
...
In general, please err on the side of not attending class if you suspect that you might be ill, with COVID-19 or anything else.
