...
So we can construct confidence intervals using the inverse cumulative distribution function for the normal distribution.
...
If you can compute your answer analytically, you probably should. But often this is difficult if not impossible without many simplifying assumptions.
...
**Wednesday/Friday**: Introduction to Decision-Making and Prescriptive Modeling 

**Homework**: Should be able to do most of HW2 (last question(s) on uncertainty may require Monday's lab).