...
**Wednesday**: Constrained optimization and solving linear models (linear programming)

**Friday**: Example of formulating and solving a linear program.

**Monday**: Lab on linear programming in Julia.

## Assessments

- HW3 released today on dissolved oxygen simulation.
- Due 10/5.
