...
Instructor: $if(author)$$author$$else$TBD$endif$ & 
TA: $if(TA)$$TA$$else$TBD$endif$ \\
Email: $if(email)$\texttt{$email$}$else$TBD$endif$ & Email: $if(TAemail)$\texttt{$TAemail$}$else$TBD$endif$ \\
Office Hours: $if(officehours)$$officehours$$else$TBD$endif$  &  Office Hours: $if(TAofficehours)$$TAofficehours$$else$TBD$endif$ \\
Office: $if(office)$$office$$else$TBD$endif$  & Office: $if(TAoffice)$$TAoffice$$else$TBD$endif$ \\\\
Course Website: $if(web)$\href{http://$web$}{\tt $web$}$else$TBD$endif$\\
Class Room: $if(classroom)$$classroom$$else$TBD$endif$\\
