...
- Will your have own repository --- let's discuss how this works.
- Don't have to finish these in class, but due by the end of next week (**Friday, 9/1, 9pm**).

## Using GitHub

- **Wednesday**: we saw how to "clone" repositories on GitHub (remote &rarr; local).
- **Today**: how to "commit" and "push" changes (local &rarr; remote)
